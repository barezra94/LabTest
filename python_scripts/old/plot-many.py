...
def change_graph_data(test_type, value1, value2):
    ...
    # @app.callback(
    #     [
    #         dash.dependencies.Output("valueName1", "options"),
    #         dash.dependencies.Output("valueName2", "options"),
    #     ],
    #     [dash.dependencies.Input("test-type", "value"),],
    # )
    # def change_values(test_type):
    #     global dataSet
    #     print("here")
    #     if test_type == "Z-Score":
    #         d = df.columns
    ...
    #         print("here2")
    #     else:
    #         dataSet = [blood_normals_male.keys()]
    #         print("here4")

    #     returnData = [{"label": i, "value": i} for i in dataSet]
    #     print("here6")
